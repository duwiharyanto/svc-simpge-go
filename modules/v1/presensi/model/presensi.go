...
type UserPresensi struct {
	Nip             string `json:"-"`
	KdJenisPegawai  string `json:"nama,omitempty"`
	KdUnitKerja     string `json:"kd_kelamin,omitempty"`
	KdLokasiKerja   string `json:"kd_nikah,omitempty"`
	Tmt             string `json:"jml_keluarga,omitempty"`
	KdJenisPresensi string `json:"kd_jenis_presensi,omitempty"`
