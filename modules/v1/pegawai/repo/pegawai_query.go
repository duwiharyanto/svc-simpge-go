...
func getListAllPegawaiPrivateQuery(req *model.PegawaiPrivateRequest) string {
	...
	COALESCE((SELECT pegawai_pendidikan.id_jenjang_pendidikan FROM pegawai_pendidikan WHERE pegawai_pendidikan.id_personal_data_pribadi =  p.id_personal_data_pribadi AND pegawai_pendidikan.flag_ijazah_diakui = 1),0) id_jenjang_pendidikan,
	COALESCE((SELECT jenjang_pendidikan.kd_jenjang FROM pegawai_pendidikan JOIN jenjang_pendidikan on jenjang_pendidikan.id = pegawai_pendidikan.id_jenjang_pendidikan WHERE pegawai_pendidikan.id_personal_data_pribadi =  p.id_personal_data_pribadi AND pegawai_pendidikan.flag_ijazah_diakui = 1),'') kd_jenjang_pendidikan,
	COALESCE((SELECT jenjang_pendidikan.jenjang FROM pegawai_pendidikan JOIN jenjang_pendidikan on jenjang_pendidikan.id = pegawai_pendidikan.id_jenjang_pendidikan WHERE pegawai_pendidikan.id_personal_data_pribadi =  p.id_personal_data_pribadi AND pegawai_pendidikan.flag_ijazah_diakui = 1),'') jenjang_pendidikan,
