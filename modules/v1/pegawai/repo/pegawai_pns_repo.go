...
func GetPegawaiPNS(a *app.App, uuid string) (*model.PegawaiPNSPTT, error) {
	...
	err := a.DB.QueryRow(sqlQuery).Scan(
		...
		&pegawaiPNSPTT.NomorPangkatGolongan,
		...
		&pegawaiPNSPTT.NomorPak,
		&pegawaiPNSPTT.TmtPak,
		&pegawaiPNSPTT.NomorSkPensiun,
		&pegawaiPNSPTT.TmtSkPensiun,
		&pegawaiPNSPTT.MasaKerjaPensiunTahun,
		&pegawaiPNSPTT.MasaKerjaPensiunBulan,
