...
func HandleGetPegawaiPrivate_v1(a *app.App, public bool) echo.HandlerFunc {
	h := func(c echo.Context) error {
		env := os.Getenv("ENV")
		fmt.Println(env)
		if public {
		...
		tanggunganResponse := GetDataTanggungan_v1(public)
...
// ini digunakan kalo uiitanggungan sudah digunakan
func GetDataTanggungan_v1(public bool) *model.TanggunganResponseBody {
	// fmt.Println(env)
	var baseURL string
