...
type PegawaiUpdateRequest struct {
	UuidTingkatPddTerakhir string `form:"uuid_tingkat_pdd_terakhir"` // uuid dari pendidikan terakhir
	UuidPendidikanTerakhir string `form:"uuid_pendidikan_terakhir"`  // uuid dari jenjang pendidikan terakhir
	UuidTingkatPddDiakui   string `form:"uuid_tingkat_pdd_diakui"`   // uuid dari pendidikan tertinggi diakui
	UuidPendidikanMasuk    string `form:"uuid_pendidikan_masuk"`     // uuid dari jenjang pendidikan tertinggi diakui
}
